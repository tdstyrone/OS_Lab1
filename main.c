...
int main() {
  ...
  // printf("\n5. LIST_ADD_TO_ITH_EMPTYLIST\n");
  // list_t *test5_list = list_alloc();
  // list_print(test5_list);
  // list_add_at_index(test5_list, 3, 0);
  // list_print(test5_list);
  // assert(1 == list_length(test5_list));
  // list_free(test5_list);
  // printf("PASS LIST_ADD_TO_ITH_EMPTYLIST\n");
  // printf("\n--------------------------------------\n");
  ...
  // printf("\n10. LIST_REMOVE_FROM_BACK_EMPTYLIST\n");
  // list_t *test10_list = list_alloc();
  // list_print(test10_list);
  // list_remove_from_back(test10_list);
  // list_print(test10_list);
  // assert(0 == list_length(test10_list));
  // list_free(test10_list);
  // printf("PASS LIST_REMOVE_FROM_BACK_EMPTYLIST\n");
  // printf("\n--------------------------------------\n");
